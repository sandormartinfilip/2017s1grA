...
public class UserServiceTest extends AbstractIntegrationTest {
	...
	// Assert.assertEquals("Exactly one user should be persisted",
	// userList.size(), 1);
	...
	// // ASSERT
	// userList = sut.getUserByLastName(LASTNAME);
	// Assert.assertEquals("Exactly two users should be persisted",
	// userList.size(), 2);
	// // Assert.assertTrue(userList.get(0).isActive());
	//
	...
	// sut.addUser(FIRSTNAME, LASTNAME, "+4975777877777",
	// "email2@msggroup.com");
	//
	// // ASSERT
	// userList = sut.getUserByLastName(LASTNAME);
